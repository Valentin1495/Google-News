export const mockNewsByCategory: NewsData = {
  value: [
    ...
    {
      name: 'Black Lives Matter movement to mark 10 years of activism, renews call to defund the police',
      url: 'https://www.msn.com/en-us/news/us/black-lives-matter-movement-to-mark-10-years-of-activism-renews-call-to-defund-the-police/ar-AA1dNe0s',
      description:
        'The Black Lives Matter movement hits a milestone on Thursday, marking 10 years since its 2013 founding in response to the acquittal of the man who fatally shot 17-year-old Trayvon Martin.Gunned down',
      provider: [
        {
          _type: 'Organization',
    ...
    {
      name: "L.A. deputy punches mother holding baby during arrest in incident sheriff called 'unacceptable'",
      url: 'https://www.msn.com/en-us/news/crime/la-deputy-punches-mother-holding-baby-during-arrest-in-incident-sheriff-called-unacceptable/ar-AA1dNnV7',
      description:
        'LOS ANGELES — A Los Angeles County sheriff’s office deputy punched a mother who was holding a 3-week-old infant during an arrest last year, in a case that has been referred to prosecutors, the',
      provider: [
        {
          _type: 'Organization',
          name: 'NBC News',
